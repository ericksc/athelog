var fetch = angular.module('fetch', []);
	...
	fetch.controller('dbCtrl', ['$scope', '$http', function ($scope, $http) {
		...
		function ReadFilterData(){
			...
			if (typeof $scope.StartDate_Input_Model !== 'undefined' && $scope.StartDate_Input_Model !== null && $scope.StartDate_Input_Model !== "") {
				FilterData['StartDate'] = $scope.StartDate_Input_Model;
			}else{
				FilterData['StartDate'] = "NONE";
			}
                        
			if (typeof $scope.EndDate_Input_Model !== 'undefined' && $scope.EndDate_Input_Model !== null && $scope.EndDate_Input_Model !== "") {
				FilterData['FinalDate'] = $scope.EndDate_Input_Model;
			}else{
				FilterData['FinalDate'] = "NONE";
			}			
		}
		//eof                
		...
		//end of function
                ...
                function CreatePatientSearchStringByID2 () {
			
			var URLstring = "../engine/dBInterface.php?ActionDBToken=SelectPatient2";
			URLstring+="&PatientID_Token="+URLParams.ID;
			//alert("(DEBUG)CreatePatientSearchString() - Patient Search String="+URLstring);
			return URLstring;
		...
		//end of function
                ...
                function CreatePatientReportGeneration(){
                
                    var URL = "../engine/dBInterface.php?ActionDBToken=ReadPatientHistoryVars";
                    URL+="&PatientID_Token="+URLParams.ID;
                ...
                //FIXME: for debug
                function CreatePatientReportGeneration2(){
                
                    var URL = "../engine/dBInterface.php?ActionDBToken=ReadPatientHistoryVars2";
                    URL+="&PatientID_Token="+URLParams.ID;
                    ...
                    URL+="&VO2Max_Test=VO2Max";
                    */
                    alert("(DEBUG)CreatePatientReportGeneration2()-Returning URL="+URL);
                    return URL;
		...
		function getUrlVars() {
			...
			return vars;
                ...
                $scope.GeneratePatientReport=function(){
                
                    ResetFilterData();
                    ReadFilterData();
                    CalldBEngine(CreatePatientReportGeneration(),"PatientData");    
