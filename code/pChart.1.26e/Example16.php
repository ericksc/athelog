 ...
 */
 ...
 $DataSet->AddPoint(array(10,3.4,6.4,0,9.8,9.8,8.7,6.4,3.4,0,-3.4,-6.4,-8.6,-9.8,-9.9),"Serie2");
 ...
 $Test->drawTitle(60,22,"Grafico para test numero 1",50,50,50,585);

 // Add an image
 $Test->drawFromPNG("Sample/logo.png",584,35);

 // Render the chart
 $Test->Render("ejemplo16.png");   
?>